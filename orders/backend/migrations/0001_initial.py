    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Пользователь с таким именем пользователя уже существует.'}, help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
                ...
                ('is_active', models.BooleanField(default=False, help_text='Указывает, следует ли считать этого пользователя активным. Снимите этот флажок вместо удаления учетных записей.', verbose_name='active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_info', to='backend.supplier', verbose_name='Поставщик')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='category',
            name='suppliers',
            field=models.ManyToManyField(blank=True, related_name='categories', to='backend.supplier', verbose_name='Поставщики'),
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('product', 'supplier', 'external_id'), name='unique_product_info'),
        ),
    ]
